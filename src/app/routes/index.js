...
// ----------- Pages Imports ---------------
import STDashboard from './app/SupplyTeachers/Dashboard';
import STLinks from './app/SupplyTeachers/Links';

import TDashboard from './app/Teachers/Dashboard';
import TLinks from './app/Teachers/Links';

import STSnippets from './app/SupplyTeachers/Snippets';
import STPages from './app/SupplyTeachers/Pages';
...
export const RoutedContent = () => {
    return (
        <Switch>
            <Redirect from="/" to="/stdashboard" exact />
            
            <Route path="/stdashboard" exact component={STDashboard} />
            <Route path="/stlinks" exact component={TLinks} />
            
            
            <Route path="/tdashboard" exact component={TDashboard} />
            <Route path="/tlinks" exact component={STLinks} />

            <Route path="/profile/snippets" exact component={STSnippets} />
            <Route path="/profile/pages" exact component={STPages} />
