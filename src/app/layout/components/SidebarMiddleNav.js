...
export const SidebarMiddleNav = () => (
    <SidebarMenu>
        ...
        <SidebarMenu.Item icon={<i className="fa fa-home"/>} title="[T] Dashboard" to='/tdashboard'/>
        <SidebarMenu.Item icon={<i className="fa fa-link"/>} title="[T] Links" to='/tlinks'/>
        <SidebarMenu.Item icon={<i className="fa fa-home"/>} title="[ST] Dashboard" to='/stdashboard'/>
        <SidebarMenu.Item icon={<i className="fa fa-link"/>} title="[ST] Links" to='/stlinks'/>
        
        
        
        {/* <SidebarMenu.Item icon={<i className="fa fa-users"/>} title="Supply Teachers" to='/supplyteachers'/> */}
        {/* <SidebarMenu.Item icon={<i className="fa fa-user-md"/>} title="Teachers" to='/teachers'/> */}
        <SidebarMenu.Item icon={<i className="fa fa-trello"/>} title="[ST] Profile">
          <SidebarMenu.Item title="Snippets" to='/profile/snippets'/>
          <SidebarMenu.Item title="Pages" to='/profile/pages'/>
        </SidebarMenu.Item>
        { /* -------- Cards ---------*/ }
